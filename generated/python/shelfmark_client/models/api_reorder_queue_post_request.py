...
class ApiReorderQueuePostRequest(BaseModel):
    """
    ApiReorderQueuePostRequest
    """ # noqa: E501
    book_priorities: Dict[str, Any] = Field(description="Mapping of book_id to new priority")
    __properties: ClassVar[List[str]] = ["book_priorities"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "book_priorities": obj.get("book_priorities")
        })
        return _obj
