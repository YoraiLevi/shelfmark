...
class ApiInspectReleasePostRequest(BaseModel):
    """
    ApiInspectReleasePostRequest
    """ # noqa: E501
    source: StrictStr = Field(description="Release source name (required)")
    source_id: StrictStr = Field(description="ID within the source (required)")
    __properties: ClassVar[List[str]] = ["source", "source_id"]
