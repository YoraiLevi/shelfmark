...
from shelfmark_client.configuration import Configuration
from shelfmark_client.api_response import ApiResponse, T as ApiResponseT
import shelfmark_client.models
from shelfmark_client import rest
from shelfmark_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'OpenAPI-Generator/1.3.15+gf57c4dc/python'
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(shelfmark_client.models, klass)
