...
class TestApiReorderQueuePostRequest(unittest.TestCase):
    """ApiReorderQueuePostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiReorderQueuePostRequest:
        """Test ApiReorderQueuePostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiReorderQueuePostRequest`
        """
        model = ApiReorderQueuePostRequest()
        if include_optional:
            return ApiReorderQueuePostRequest(
                book_priorities = { }
            )
        else:
            return ApiReorderQueuePostRequest(
    ...
    def testApiReorderQueuePostRequest(self):
        """Test ApiReorderQueuePostRequest"""
