...
class TestApiActivityDismissPostRequest(unittest.TestCase):
    """ApiActivityDismissPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiActivityDismissPostRequest:
        """Test ApiActivityDismissPostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiActivityDismissPostRequest`
        """
        model = ApiActivityDismissPostRequest()
        if include_optional:
            return ApiActivityDismissPostRequest(
                item_type = '',
                item_key = ''
            )
        else:
    ...
    def testApiActivityDismissPostRequest(self):
        """Test ApiActivityDismissPostRequest"""
