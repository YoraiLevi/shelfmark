...
class TestApiCreateRequestPostRequest(unittest.TestCase):
    """ApiCreateRequestPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiCreateRequestPostRequest:
        """Test ApiCreateRequestPostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiCreateRequestPostRequest`
        """
        model = ApiCreateRequestPostRequest()
        if include_optional:
    ...
    def testApiCreateRequestPostRequest(self):
        """Test ApiCreateRequestPostRequest"""
